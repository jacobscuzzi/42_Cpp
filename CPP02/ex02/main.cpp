...
Fixed sum3 = Fixed(-3) + Fixed(7);
Fixed sum4 = Fixed(-2.5f) + Fixed(-1.5f);
Fixed sum5 = Fixed(0) + Fixed(0);
Fixed sum6 = Fixed(10000) + Fixed(0.001f);
std::cout << "b + Fixed(5) = " << b << " + " << Fixed(5) << " = " << sum1 << std::endl;
std::cout << "Fixed(1.5f) + Fixed(2.5f) = " << Fixed(1.5f) << " + " << Fixed(2.5f) << " = " << sum2 << std::endl;
std::cout << "Fixed(-3) + Fixed(7) = " << Fixed(-3) << " + " << Fixed(7) << " = " << sum3 << std::endl;
std::cout << "Fixed(-2.5f) + Fixed(-1.5f) = " << Fixed(-2.5f) << " + " << Fixed(-1.5f) << " = " << sum4 << std::endl;
std::cout << "Fixed(0) + Fixed(0) = " << Fixed(0) << " + " << Fixed(0) << " = " << sum5 << std::endl;
std::cout << "Fixed(10000) + Fixed(0.001f) = " << Fixed(10000) << " + " << Fixed(0.001f) << " = " << sum6 << std::endl;
std::cout << std::endl;
...
Fixed diff3 = Fixed(-5) - Fixed(-2);
Fixed diff4 = Fixed(0) - Fixed(0);
Fixed diff5 = Fixed(2.5f) - Fixed(5.5f);
std::cout << "c - b = " << c << " - " << b << " = " << diff1 << std::endl;
std::cout << "Fixed(10) - Fixed(3) = " << Fixed(10) << " - " << Fixed(3) << " = " << diff2 << std::endl;
std::cout << "Fixed(-5) - Fixed(-2) = " << Fixed(-5) << " - " << Fixed(-2) << " = " << diff3 << std::endl;
std::cout << "Fixed(0) - Fixed(0) = " << Fixed(0) << " - " << Fixed(0) << " = " << diff4 << std::endl;
std::cout << "Fixed(2.5f) - Fixed(5.5f) = " << Fixed(2.5f) << " - " << Fixed(5.5f) << " = " << diff5 << std::endl;
std::cout << std::endl;
...
Fixed mult3 = Fixed(-2) * Fixed(5);
Fixed mult4 = Fixed(0) * Fixed(100);
Fixed mult5 = Fixed(-1.5f) * Fixed(-2.5f);
std::cout << "Fixed(3) * Fixed(4) = " << Fixed(3) << " * " << Fixed(4) << " = " << mult1 << std::endl;
std::cout << "Fixed(2.5f) * Fixed(2) = " << Fixed(2.5f) << " * " << Fixed(2) << " = " << mult2 << std::endl;
std::cout << "Fixed(-2) * Fixed(5) = " << Fixed(-2) << " * " << Fixed(5) << " = " << mult3 << std::endl;
std::cout << "Fixed(0) * Fixed(100) = " << Fixed(0) << " * " << Fixed(100) << " = " << mult4 << std::endl;
std::cout << "Fixed(-1.5f) * Fixed(-2.5f) = " << Fixed(-1.5f) << " * " << Fixed(-2.5f) << " = " << mult5 << std::endl;
std::cout << std::endl;
...
Fixed div3 = Fixed(-10) / Fixed(2);
Fixed div4 = Fixed(0) / Fixed(5);
Fixed div5 = Fixed(5) / Fixed(-2);
//Fixed div6 = Fixed(5) / Fixed(0);
...
std::cout << "Fixed(-10) / Fixed(2) = " << Fixed(-10) << " / " << Fixed(2) << " = " << div3 << std::endl;
std::cout << "Fixed(0) / Fixed(5) = " << Fixed(0) << " / " << Fixed(5) << " = " << div4 << std::endl;
std::cout << "Fixed(5) / Fixed(-2) = " << Fixed(5) << " / " << Fixed(-2) << " = " << div5 << std::endl;
//std::cout << "Fixed(5) / Fixed(0) = " << Fixed(5) << " / " << Fixed(0) << " = " << div6 << std::endl;
std::cout << std::endl;
